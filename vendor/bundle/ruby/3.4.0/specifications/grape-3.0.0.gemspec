...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<dry-types>.freeze, [">= 1.1".freeze])
  s.add_runtime_dependency(%q<mustermann-grape>.freeze, ["~> 1.1.0".freeze])
  s.add_runtime_dependency(%q<rack>.freeze, [">= 2".freeze])
